...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/facebook-group-scraper?style=social)](https://github.com/data-scrape/facebook-group-scraper)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/facebook-group-scraper?style=social)](https://github.com/data-scrape/facebook-group-scraper/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/facebook-group-scraper)](https://github.com/data-scrape/facebook-group-scraper/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/facebook-group-scraper)](https://github.com/data-scrape/facebook-group-scraper/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> Facebook group scraper - extract group posts, members, discussions


<!-- SEO keywords: facebook group scraper, Facebook Group Scraper, facebook group scraper python, facebook group scraper github -->
...
- Extract Facebook group posts, members, discussions
- Group name, description, member count, privacy type
- Post extraction with author, text, media, timestamp
- Comment extraction with replies
- Reaction counts breakdown
- Filter posts by date, keyword, or author

## 🎯 Use Cases

Monitor community discussions, track brand mentions in groups.
...
```bash
pip install git+https://github.com/data-scrape/facebook-group-scraper.git
```

### From source

```bash
git clone https://github.com/data-scrape/facebook-group-scraper.git
...
```python
from facebook_group_scraper import Scraper
...
```bash
python facebook_group_scraper.py --query "your-query" --output results.json
```
...
### Is Facebook Group Scraper legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/facebook-group-scraper)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/facebook-group-scraper/issues)
