#!/usr/bin/env python3
"""
Facebook Group Scraper - Facebook group scraper - extract group posts, members, discussions
"""
...
class Scraper:
    """Main scraper class for Facebook Group Scraper."""
...
def main():
    import argparse
    p = argparse.ArgumentParser(description="Facebook Group Scraper")
